...
<div class="space-y-12">
	<section class="text-center py-12">
		...
		<div class="mt-8 flex justify-center space-x-4">
			...
			<a
				href="/search"
				class="px-6 py-3 bg-gray-200 dark:bg-gray-700 text-gray-900 dark:text-gray-100 rounded-lg font-medium hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors"
			>
				Search
			</a>
		</div>
	...
	{:else}
		<section>
			<div class="flex justify-between items-center mb-6">
				<h2 class="text-3xl font-bold text-gray-900 dark:text-gray-100">Upcoming Events</h2>
				<a href="/events" class="text-blue-600 dark:text-blue-400 hover:underline">View all</a>
			</div>
		...
		<section>
			<div class="flex justify-between items-center mb-6">
				<h2 class="text-3xl font-bold text-gray-900 dark:text-gray-100">Top Ranked Bots</h2>
				<a href="/rankings" class="text-blue-600 dark:text-blue-400 hover:underline">View rankings</a>
			</div>
			
			{#if topBots.length === 0}
				<p class="text-gray-600 dark:text-gray-400">No rankings data available</p>
			{:else}
				<div class="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-6 gap-6">
					{#each topBots as bot}
