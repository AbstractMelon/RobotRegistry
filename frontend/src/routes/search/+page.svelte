...
<div class="space-y-6">
	<div>
		<h1 class="text-4xl font-bold text-stone-900 dark:text-stone-100 mb-6">Search</h1>
		...
		<div class="flex gap-4">
			<input
				...
				class="flex-1 px-4 py-3 border border-stone-300 dark:border-stone-600 rounded-xl 
	...
	{:else if hasSearched && results}
		<div class="space-y-8">
			{#if results.events && results.events.length > 0}
				<div>
					<h2 class="text-2xl font-bold text-stone-900 dark:text-stone-100 mb-4">
			...
			{#if (!results.events || results.events.length === 0) && 
				...
				<div class="text-center py-12">
					<p class="text-stone-600 dark:text-stone-400">No results found for "{query}"</p>
				</div>
			{/if}
		</div>
	{:else if hasSearched}
		<div class="text-center py-12">
			<p class="text-stone-600 dark:text-stone-400">Enter a search query to get started</p>
		</div>
	{/if}
</div>